...
pdf: $(XSL_PRINT) manual.xml $(SRCS) Makefile
	...
	fop -fo $(BASENAME)$(VERSION)_manual-fr.fo -pdf $(BASENAME)$(VERSION)_manual-fr.pdf
...
pdfA4: $(XSL_PRINT) manual.xml $(SRCS) Makefile
	...
	fop -fo $(BASENAME)$(VERSION)_manual-fr_A4.fo -pdf $(BASENAME)$(VERSION)_manual-fr_A4.pdf
